...
{
  "extra": {
    "backendUrl": "https://cricapp-admob-unity.preview.emergentagent.com"
  }
}
```
...
return 'https://cricapp-admob-unity.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://cricapp-admob-unity.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://cricapp-admob-unity.preview.emergentagent.com
