...
{
  "extra": {
    "backendUrl": "https://cricapp-preview.preview.emergentagent.com"
  }
}
```
...
return 'https://cricapp-preview.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://cricapp-preview.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://cricapp-preview.preview.emergentagent.com
