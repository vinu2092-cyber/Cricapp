...
{
  "extra": {
    "backendUrl": "https://match-updates-22.preview.emergentagent.com"
  }
}
```
...
return 'https://match-updates-22.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://match-updates-22.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://match-updates-22.preview.emergentagent.com
