...
{
  "extra": {
    "backendUrl": "https://dynamic-key-manager.preview.emergentagent.com"
  }
}
```
...
return 'https://dynamic-key-manager.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://dynamic-key-manager.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://dynamic-key-manager.preview.emergentagent.com
