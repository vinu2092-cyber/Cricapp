...
{
  "extra": {
    "backendUrl": "https://api-key-rotation-3.preview.emergentagent.com"
  }
}
```
...
return 'https://api-key-rotation-3.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://api-key-rotation-3.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://api-key-rotation-3.preview.emergentagent.com
