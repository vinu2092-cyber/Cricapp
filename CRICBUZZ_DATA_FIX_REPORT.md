...
{
  "extra": {
    "backendUrl": "https://cricapp-release.preview.emergentagent.com"
  }
}
```
...
return 'https://cricapp-release.preview.emergentagent.com';
```
...
Frontend API Service (/app/frontend/src/services/api.ts)
    ↓
Backend Proxy (https://cricapp-release.preview.emergentagent.com/api/cricket/*)
    ↓
...
**Backend URL**: https://cricapp-release.preview.emergentagent.com
