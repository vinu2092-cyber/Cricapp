              ...
              <>
                ...
                <TouchableOpacity
                  ...
                  onPress={async () => {
                    ...
                    if (shown) {
                      // Genuine ad watched → unlock Pro immediately (1 ad)
                ...
                {/* v1.0.15 — Share to unlock 30 min Pro (1/day quota).
                    Single button opens native ACTION_SEND share intent
                    (WhatsApp / Telegram / Instagram / Facebook / Gmail /
                    SMS etc). Pro is granted ONLY on Share.sharedAction
                    (native success signal). Quota protects AdMob income. */}
                <TouchableOpacity
